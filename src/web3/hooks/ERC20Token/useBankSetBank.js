...
export default function useBankSetBank() {
  const methodName = "setBank";
  ...
  const {
    ...
    fetchTransaction: fetchSetBankTx
  ...
  return {
    /** Tx Fee */
    isCallSuccessSetBankTxFee: isCallSuccess,
    isLoadingSetBankTxFee: isLoadingTxFee,
    fetchSetBankTxFee: fetchTrxFee,
    displaySetBankTxFee: display,
    setSetBankTxFeeLoading: setLoading,

    /** Tx */
    isLoadingSetBankTx: isLoadingTx,
    fetchSetBankTx,

    /** Helpers */
    isValidSetBankTx: isValidTx
  };
}
